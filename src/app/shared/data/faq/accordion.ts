...
export const accordion1: Accordion[] = [
    {
...
export const accordion3: Accordion[] = [
    {
        title: "WordPress Site Maintenance ?",
        content: "Lorem ipsum dolo,r sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
        icon: "file-text",
        panel : 'first'
    },
    {
...
export const accordion4: Accordion[] = [
    {
        title: "WordPress Site Maintenance ?",
        content: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
        icon: "file-text",
